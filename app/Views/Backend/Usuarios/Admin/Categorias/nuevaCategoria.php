    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <?= form_open_multipart('/usuario/tienda/categorias/nuevo') ?>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre de la categoria" value="<?= set_value('nombre') ?>">
                            </div>
